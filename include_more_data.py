        ...
        try:
            ...
            while total_records < 30000:
                ...
                if response.status_code == 200:
                    ...
                    if not results:
                        break  # Exit the loop if no results are returned (we've reached the last page)
                    ...
                    missing_columns = [col for col in desired_columns if col not in normalized_data.columns]
                    ...
                    if missing_columns:
                        ...
                        print(f"Loaded {len(results)} records, total: {len(all_data) * limit} records.")
...
#######
    ...
    def clean_data(self):
        ...
        if self.df is not None:
            ...
            if 'principal_investigator_1_specialty_1' in self.df.columns:
                self.df['principal_investigator_1_specialty_1'] = self.df['principal_investigator_1_specialty_1'].apply(
                    lambda x: str(x).split('Allopathic & Osteopathic Physician', 1)[-1].strip() 
        ...
        # if 'principal_investigator_1_specialty_1' in self.df.columns:
        #         self.df['principal_investigator_1_specialty_1'] = self.df['principal_investigator_1_specialty_1'].apply(
        #             lambda x: x.split('Allopathic & Osteopathic Physicians')[1] if 'Allopathic & Osteopathic Physicians' in str(x) else x
        #         )
